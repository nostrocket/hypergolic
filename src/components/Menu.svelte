...
<ul class="space-y-2 font-medium">
	...
	<li>
		...
		>
			<img
				alt=""
				src="/horus-eye.png"
				class="h-5 w-5 flex-shrink-0 fill-slate-50 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
			/>
	...
	<li>
		...
		>
			...
			<span class="ms-3 flex-1 whitespace-nowrap">People</span>
		</a>
	</li>
	<li>
		<a
